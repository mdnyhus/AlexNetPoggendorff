...
folder="gapMiddleHalvesFlipped2"
angle_degrees = 55
...
shift = -1*math.ceil((dimension - 1.0) / 4)
...
draw.line((lx - shift, ry - seg_height/2, lcenterx - shift, rcentery - seg_height/2), fill=0, width=width)

draw.line((rx - shift, ly - seg_height/2, rcenterx - shift, lcentery - seg_height/2), fill=0, width=width)

draw.line((lcenterx - shift, rcentery - seg_height/2, rcenterx - shift, lcentery - seg_height/2), fill=0, width=width)

drawW.line((lx - shift, ry - seg_height/2, lcenterx - shift, rcentery - seg_height/2), fill=0, width=widthW)
drawW.line((rx - shift, ly - seg_height/2, rcenterx - shift, lcentery - seg_height/2), fill=0, width=widthW)
drawW.line((lcenterx - shift, rcentery - seg_height/2, rcenterx - shift, lcentery - seg_height/2), fill=0, width=widthW)
...
avgW = Image.new('RGB', (dimension, dimension), (255,255,255))
drAvgW = ImageDraw.Draw(avgW)
...
for i in range(seg_height*2 + round(math.tan(angle) * gap) + 1):
  ...
  drAvgW.line((rx + shift, ry, rcenterx + shift, rcentery), fill=colour, width=widthW)
  drAvgW.line((lcenterx + shift, lcentery, rcenterx + shift, rcentery), fill=colour, width=widthW)
...
drAvgW.line((lcenterx + shift, margin, lcenterx + shift, dimension - 1 - margin), fill=0, width=widthW)
drAvgW.line((rcenterx + shift, margin, rcenterx + shift, dimension - 1 - margin), fill=0, width=widthW)
drAvgW.line((lx + shift, ly, lcenterx + shift, lcentery), fill=0, width=widthW)
avgW.save(folder + "/averageWide.png")
avgW.show()