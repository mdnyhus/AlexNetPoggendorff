...
draw.line((lx, ly, lcenterx, lcentery), fill=0, width=width)
...
draw.line((rx, ry, rcenterx, rcentery), fill=0, width=width)

draw.line((lcenterx, lcentery, rcenterx, rcentery), fill=0, width=width)
