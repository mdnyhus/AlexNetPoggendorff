...
draw.line((lx - shift, ly, lcenterx - shift, lcentery), fill=0, width=width)
...
draw.line((rx - shift, ry, rcenterx - shift, rcentery), fill=0, width=width)

draw.line((lcenterx - shift, lcentery, rcenterx - shift, rcentery), fill=0, width=width)
